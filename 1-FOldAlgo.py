...
dorsal_values = normalize_fishdata(dorsal_values,min_dorsal,max_dorsal)
#Plotting figure after Scaling
fishplot_after_nor = plotfish(body_values,dorsal_values,type_values)
...
fishplot_after_std = plotfish(body_values,dorsal_values,type_values)
...
def confusion_matrix(pred_type_array,type_test):
	#pred_type_array,type_train_K[K]

	#print('\n')
	#print('pred_type_array inside confu matrix',pred_type_array)
	#print('\ntype_test inside confu matrix',type_test)
	nonmatch_count = 0
	TP = 0
	TN = 0
	FP = 0
